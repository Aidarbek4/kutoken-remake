    ...
    if (animationNavItem) {
        animationNavItem.addEventListener('click', function (e) {
            ...
            setTimeout(function () {
                ...
                homeText.textContent = "Кут Технологии - это интегрированный процесс, основанный на передовых технологиях, который позволяет более точно и эффективно извлекать ценные ресурсы из недр Земли.";
